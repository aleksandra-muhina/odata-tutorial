sap.ui.define([
	...
	"sap/ui/thirdparty/sinon", //Sinon is a third party Javascript lib for test spies and mocks
	"sap/base/Log"
	...
	var oSandbox = sinon.sandbox.create(),
		...
		sNamespace = "tutorial/tutorial",
		// Component for writing logs into the console
		sLogComponent = "tutorial.mockserver",
	...
	return {
		...
		init : function () {
			...
			return readData().then(function () {
				...
				// Different levels correspond to different severities of logs (0 = None, 1 = Error, 2 = Warning, 3 = Info, 4 = Debug)
				Log.setLevel(3, sLogComponent);

				//This line logs an informational message to the console
