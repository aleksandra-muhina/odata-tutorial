		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tutorialtutorial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tutorialtutorial-display": {
								"semanticObject": "tutorialtutorial",
								"action": "display",
								"description": "An oData Tutorial.",
								"title": "oData Tutorial",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tutorial.tutorial",
									"url": sap.ui.require.toUrl("tutorial/tutorial")
								}
							}
						}
					}
